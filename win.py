...
class Win:
    ...
    def Execute(self, screen, gameController): 
        self.button1 = Button2( 400, 400, 180, 90, action = self.manager.CreateLvl, ac = white, ic = (0,25,0), image_name = "Next", size = 50, argument = (self.manager.currLvl + 1))
        self.button2 = Button2( 650, 400, 180, 90, action = exit, ac = white, ic = (0,25,0), image_name = "QUIT", size = 50)
